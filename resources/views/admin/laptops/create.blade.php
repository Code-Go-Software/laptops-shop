  ...
  <div class="row justify-content-center col-12 mt-3">
    <form action="/admin/laptops" method="post" class="col-md-8 col-12" enctype="multipart/form-data">
      ...
      <div class="form-group text-center">
        ...
        <br>
        <div class="btn bg-success text-light mt-2" onclick="openFileInput('#image-file')">
      ...
      <div class="form-group">
        ...
        <input type="text" name="name" id="name" class="form-control border-secondary" placeholder="Asus 10.255 LS850" value="{{ old('name') }}">
        @error('name')
      ...
      <div class="form-group">
        ...
        class="form-control border-secondary" placeholder="سعر الحاسوب قبل الحسم" value="{{ old('before_discount_price') }}">
      ...
      <div class="form-group">
        ...
        class="form-control border-secondary" placeholder="سعر الحاسوب بعد الحسم" value="{{ old('after_discount_price') }}">
      ...
      <div class="form-group">
        ...
        <input type="text" name="company" id="company" class="form-control border-secondary" placeholder="Asus" value="{{ old('company') }}">
        @error('company')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="cpu" id="cpu" class="form-control border-secondary" placeholder="Corei5-7848 2.4 GHZ" value="{{ old('cpu') }}">
        @error('cpu')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="ram" id="ram" class="form-control border-secondary" placeholder="8 GB DDR4" value="{{ old('ram') }}">
        @error('ram')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="hard" id="hard-drive" class="form-control border-secondary" placeholder="1 TB HDD" value="{{ old('hard') }}">
        @error('hard')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="screen_card" id="screen-card" class="form-control border-secondary" placeholder="AMD RTX-4500 2GB" value="{{ old('screen_card') }}">
        @error('screen_card')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="screen_size" id="screen-size" class="form-control border-secondary" placeholder="15.6 INCH" value="{{ old('screen_size') }}">
        @error('screen_size')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="cd_driver" id="cd-rom" class="form-control border-secondary" placeholder="CD/ROM قراءة وكتابة" value="{{ old('cd_driver') }}">
        @error('cd_driver')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="battery" id="battery" class="form-control border-secondary" placeholder="تعمل ل 4 ساعات متواصل" value="{{ old('battery') }}">
        @error('battery')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="ports" id="ports" class="form-control border-secondary" placeholder="USB 3 + HDMI"  value="{{ old('ports') }}">
        @error('ports')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <select class="form-control border-secondary" name="category_id" id="category">
      ...
      <div class="form-group">
        ...
        <select class="form-control border-secondary" name="is_available" id="is-available">
      ...
      <div class="form-group">
        <button type="submit" class="btn bg-success text-light btn-block"><i class="lni lni-plus"></i> إضافة الحاسوب</button>
      </div>
