  ...
  <form action="/admin/laptops" method="post" class="col-12 row mt-3" enctype="multipart/form-data">
    ...
    <div class="col-4">
      ...
      <div class="form-group">
        ...
        <input type="text" name="name" id="name" class="form-control rounded-pill border-dark" placeholder="Asus 10.255 LS850" value="{{ old('name') }}">
        @error('name')
          <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="سعر المنتج قبل الحسم" value="{{ old('before_discount_price') }}">
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="بالدولار الأمريكي" value="{{ old('after_discount_price') }}">
      ...
      <div class="form-group">
        ...
        <input type="text" name="company" id="company" class="form-control rounded-pill border-dark" placeholder="Asus" value="{{ old('company') }}">
        @error('company')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
    ...
    <div class="col-4">
      ...
      <div class="form-group">
        ...
        <input type="text" name="cpu" id="cpu" class="form-control rounded-pill border-dark" placeholder="Corei5-7848 2.4 GHZ" value="{{ old('cpu') }}">
        @error('cpu')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="ram" id="ram" class="form-control rounded-pill border-dark" placeholder="8 GB DDR4" value="{{ old('ram') }}">
        @error('ram')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="hard" id="hard-drive" class="form-control rounded-pill border-dark" placeholder="1 TB HDD" value="{{ old('hard') }}">
        @error('hard')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="screen_card" id="screen-card" class="form-control rounded-pill border-dark" placeholder="AMD RTX-4500 2GB" value="{{ old('screen_card') }}">
        @error('screen_card')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="screen_size" id="screen-size" class="form-control rounded-pill border-dark" placeholder="15.6 INCH" value="{{ old('screen_size') }}">
        @error('screen_size')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="cd_driver" id="cd-rom" class="form-control rounded-pill border-dark" placeholder="CD/ROM قراءة وكتابة" value="{{ old('cd_driver') }}">
        @error('cd_driver')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="battery" id="battery" class="form-control rounded-pill border-dark" placeholder="تعمل ل 4 ساعات متواصل" value="{{ old('battery') }}">
        @error('battery')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="ports" id="ports" class="form-control rounded-pill border-dark" placeholder="USB 3 + HDMI"  value="{{ old('ports') }}">
        @error('ports')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
    ...
    <div class="col-4">
      ...
      <div class="form-group">
        ...
        <textarea id="description" name="description" class="form-control rounded border-dark" cols="30" rows="10" placeholder="هل يوجد أي ملاحظات أخرى حول الحاسوب؟">{{ old('description') }}</textarea>
        @error('description')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
