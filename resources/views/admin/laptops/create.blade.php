  ...
  <form action="/admin/laptops" method="post" class="col-12 row mt-3" enctype="multipart/form-data">
    ...
    <div class="col-4">
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-secondary" placeholder="سعر المنتج قبل الحسم" value="{{ old('before_discount_price') }}">
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-secondary" placeholder="بالدولار الأمريكي" value="{{ old('after_discount_price') }}">
