  ...
  <div class="col-12 row justify-content-center">
    <form action="/admin/laptops/image/{{ $laptop->id }}" method="post" class="col-4" enctype="multipart/form-data">
      ...
      <div class="form-group text-center">
        ...
        @enderror
        <div class="btn btn-primary btn-block rounded-pill mt-2 mb-2" onclick="openFileInput('#main-image-file')">
  ...
  <form action="/admin/laptops/{{ $laptop->id }}" method="post" class="col-12 row mt-3">
    ...
    <div class="col-4">
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="بالدولار الأمريكي" value="{{ $laptop->before_discount_price }}">
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="بالدولار الأمريكي" value="{{ $laptop->after_discount_price }}">
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="Asus" value="{{ $laptop->company }}">
        @error('company')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
    ...
    <div class="col-4">
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="Corei5-7848 2.4 GHZ" value="{{ $laptop->cpu }}">
        @error('cpu')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="8 GB DDR4" value="{{ $laptop->ram }}">
        @error('ram')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="1 TB HDD" value="{{ $laptop->hard }}">
        @error('hard')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="AMD RTX-4500 2GB" value="{{ $laptop->screen_card }}">
        @error('screen_card')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="15.6 INCH" value="{{ $laptop->screen_size }}">
        @error('screen_size')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="CD/ROM قراءة وكتابة" value="{{ $laptop->cd_driver }}">
        @error('cd_driver')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="تعمل ل 4 ساعات متواصل" value="{{ $laptop->battery }}">
        @error('battery')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
      ...
      <div class="form-group">
        ...
        class="form-control rounded-pill border-dark" placeholder="USB 3 + HDMI" value="{{ $laptop->ports }}">
        @error('ports')
            <small class="text-danger">{{ $message }}</small>
        @enderror
      </div>
    ...
    <div class="col-4">
      ...
      <div class="form-group">
        ...
        class="form-control rounded border-dark" cols="30" rows="10"
