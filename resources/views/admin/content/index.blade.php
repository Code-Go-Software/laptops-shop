  ...
  <div class="col-12 mt-3">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item">
        ...
        <a class="nav-link active" id="main-info-tab"
        data-toggle="tab" href="#main-info" role="tab"
        aria-controls="main-info" aria-selected="true">المعلومات الأساسية</a>

      </li>
      <li class="nav-item">

        <a class="nav-link" id="sliders-tab"
        data-toggle="tab" href="#sliders" role="tab"
        aria-controls="sliders" aria-selected="false">الصور الإعلانية</a>
          ...
          <div class="col-lg-9">
            <form action="/admin/content/{{ $content->where('key', 'slide1')->first()->id }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group text-center">
                ...
                <div id="select-slide1" class="btn bg-primary text-light mt-2" onclick="openFileInput('#slide1')">
                  <i class="lni lni-image"></i> اختيار صورة جديدة
                </div>
                <button type="submit" class="btn bg-success text-light mt-2"><i class="lni lni-save"></i> حفظ الصورة</button>
              </div>
            </form>
          </div>
          ...
          <div class="col-lg-9 mt-4">
            <form action="/admin/content/{{ $content->where('key', 'slide2')->first()->id }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group text-center">
                ...
                <div id="select-slider2" class="btn bg-primary text-light mt-2" onclick="openFileInput('#slide2')">
                  <i class="lni lni-image"></i> اختيار صورة جديدة
                </div>
                <button type="submit" class="btn bg-success text-light mt-2"><i class="lni lni-save"></i> حفظ الصورة</button>
              </div>
          ...
          <div class="col-lg-9 mt-4">
            <form action="/admin/content/{{ $content->where('key', 'slide3')->first()->id }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group text-center">
                ...
                <div id="select-slider3" class="btn bg-primary text-light mt-2" onclick="openFileInput('#slide3')">
                  <i class="lni lni-image"></i> اختيار صورة جديدة
                </div>
                <button type="submit" class="btn bg-success text-light mt-2"><i class="lni lni-save"></i> حفظ الصورة</button>
              </div>
