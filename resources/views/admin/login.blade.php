      ...
      <div class="col-4 mt-5">
        ...
        <form action="" method="POST">
          <div class="form-group">
            ...
            <input type="text" id="email" class="form-control border border-dark" placeholder="user@email.com">
        </div>
        <div class="form-group">
            <label for="password"><i class="lni lni-eye"></i> كلمة السر</label>
            <input type="password" id="password" class="form-control border border-dark" placeholder="********">
        </div>
        <div class="form-group">
