...
@section('title', 'اسم الشركة لتجارة جميع أنواع اللابتوبات | القائمة المفضلة')
@section('description', 'أنشأ حسابك الآن مجانا في متجر اسم الشركة الإلكتروني وتحكم بقائمتك المفضلة كما تريد اطلب حاسوبك الآن ودعنا نتولى بقية التفاصيل')
