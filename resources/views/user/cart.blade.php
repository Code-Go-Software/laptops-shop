...
@section('title', 'دبي غروب لتجارة جميع أنواع اللابتوبات | سلة المشتريات')
@section('description', 'أنشأ حسابك الآن مجانا في متجر دبي غروب الإلكتروني وتحكم بسلة مشترياتك كما تريد اطلب حاسوبك الآن ودعنا نتولى بقية التفاصيل')
