      ...
      <div class="row">
        <div class="col-12 mb-5">
          <div class="shadow px-2 py-3 row">
            <div class="col-12">
              <select id="category" class="form-control form-control-sm d-inline-block w-auto mr-3 border-dark rounded-pill mb-3">
                <option value="">حواسيب جديدة</option>
                <option value="">حواسيب مستعملة</option>
              </select>
              <select id="price" class="form-control form-control-sm d-inline-block w-auto mr-3 border-dark rounded-pill mb-3">
